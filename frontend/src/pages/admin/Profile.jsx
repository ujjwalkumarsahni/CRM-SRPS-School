...
const AdminProfile = () => {
  ...
  return (
    <div className="">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        {/* Header Section */}
        <div className="px-6 py-8" style={{ backgroundColor: colors.primary }}>
          <div className="flex items-center gap-6">
            <div className="relative">
              <div
              ...
              {editing && (
                <label
                  className="absolute bottom-0 right-0 p-1.5 rounded-full cursor-pointer shadow-lg transition-all hover:scale-110"
                  style={{ backgroundColor: colors.secondary }}
                >
                  <Camera size={14} style={{ color: colors.primary }} />
                  <input
                    type="file"
                    name="photo"
                    accept="image/*"
        ...
        {!editing && (
          <div
            className="px-6 pt-4 flex justify-end gap-3 pb-4"
        ...
        {!editing ? (
              ...
              <div className="flex items-start gap-3">
                <div className="mt-1">
                  {profileData?.isVerified ? (
                    ...
                    <XCircle size={20} style={{ color: colors.secondary }} />
                  )}
                </div>
                <div>
                  <p className="text-sm text-gray-500">Account Status</p>
                  <p
                    className={`font-medium ${profileData?.isVerified ? "text-green-600" : ""}`}
                    style={
                      !profileData?.isVerified
          ...
          <form onSubmit={handleUpdateProfile} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  value={editForm.email}
                  onChange={handleEditChange}
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-opacity-50 bg-gray-50"
                  style={{ focusRingColor: colors.primary }}
                  disabled
                />
            ...
            <div
              ...
              style={{ borderTop: `1px solid ${colors.light}` }}
            >
              <button
                type="submit"
                disabled={editLoading}
                className="flex-1 text-white py-2.5 rounded-lg font-semibold transition-all duration-200 hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2"
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <form onSubmit={handleChangePassword} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  New Password <span style={{ color: colors.accent }}>*</span>
                </label>
                <div className="relative">
                  <Key
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="submit"
                  disabled={editLoading}
                  className="flex-1 text-white py-2 rounded-lg transition-all duration-200 hover:opacity-90 disabled:opacity-50"
                  style={{ backgroundColor: colors.primary }}
                >
                  {editLoading ? "Changing..." : "Change Password"}
                </button>
