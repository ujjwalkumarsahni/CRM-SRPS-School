...
const LeaveManagement = () => {
  ...
  const handleProcessLeave = async (leaveId, status) => {
    const result = await Swal.fire({
      ...
      html: `
        <div class="text-left">
          <label class="block text-sm font-medium text-gray-700 mb-2">Remarks (Optional)</label>
          <textarea id="remarks" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-opacity-50" rows="3" placeholder="Add any remarks..."></textarea>
        </div>
      `,
      icon: status === "approved" ? "question" : "warning",
      showCancelButton: true,
      confirmButtonColor: status === "approved" ? "#10B981" : colors.accent,
      cancelButtonColor: "#6B7280",
      confirmButtonText: status === "approved" ? "Yes, Approve" : "Yes, Reject",
      cancelButtonText: "Cancel",
      preConfirm: () => {
  ...
  const viewLeaveDetails = (leave) => {
    ...
    Swal.fire({
      ...
      html: `
        <div style="text-align: left;">
          <div class="mb-4 p-4" style="background: ${colors.light}; border-radius: 12px;">
            <div class="flex items-center gap-2 mb-2">
              <div style="width: 32px; height: 32px; background: ${colors.primary}; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                <span style="color: white; font-weight: bold;">${leave.teacher?.name?.charAt(0).toUpperCase() || "N"}</span>
              </div>
              <div>
                <span class="font-semibold" style="color: ${colors.primary};">${leave.teacher?.name || "N/A"}</span>
                <div class="text-xs" style="color: #6B7280;">${leave.teacher?.email || "N/A"}</div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              <XCircle size={20} style={{ color: colors.accent }} />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-opacity-50 transition-all"
            ...
            {activeTab === "all" && (
              <div className="relative md:w-64">
                ...
                <select
                  value={filterStatus}
                  onChange={(e) => setFilterStatus(e.target.value)}
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-opacity-50 appearance-none cursor-pointer"
                  style={{ focusRingColor: colors.primary }}
                  onFocus={(e) =>
                    (e.target.style.boxShadow = `0 0 0 2px ${colors.primary}20`)
                  }
            ...
            {(searchTerm ||
              ...
              <button
                onClick={clearFilters}
                className="px-4 py-2.5 rounded-lg flex items-center gap-2 transition-all hover:opacity-80"
              ...
              <table className="w-full">
                <thead>
                  <tr style={{ backgroundColor: colors.primary }}>
                    ...
                    <th className="text-left py-3 px-4 text-sm font-semibold text-white hidden md:table-cell">
                      Reason
                    </th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-white">
                      Status
                    </th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-white hidden lg:table-cell">
                      Submitted
                    </th>
                      ...
                      >
                        <td className="py-3 px-4">
                          <div className="flex items-center gap-3">
                            ...
                            >
                              {leave.teacher?.name?.charAt(0).toUpperCase() ||
                                "N"}
                            </div>
                            <div>
                            ...
                            {leave.status === "pending" && (
                              <>
                                <button
                                  ...
                                  className="p-1.5 text-green-600 rounded-lg transition-all duration-200 hover:scale-110 hover:bg-green-50"
                                  title="Approve"
                                >
                                  <CheckCircle size={16} />
                                </button>
                                <button
                                  ...
                                  className="p-1.5 rounded-lg transition-all duration-200 hover:scale-110 hover:bg-red-50"
                                  style={{ color: colors.accent }}
                                  title="Reject"
                                >
                                  <XCircle size={16} />
            ...
            <div className="mt-6 flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-1"
                  style={{ color: colors.primary }}
                >
                  <ChevronLeft size={16} />
                  Previous
