  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          {/* Header */}
          <div className="px-6 py-4 flex justify-between items-center sticky top-0 z-10" style={{ backgroundColor: colors.primary }}>
            <h3 className="text-xl font-semibold text-white">
              Teacher Details
            </h3>
            <button
          ...
          <div className="p-6">
            {/* Profile Header */}
            <div className="flex items-center gap-4 mb-6 pb-4 border-b" style={{ borderColor: colors.light }}>
              <div className="w-24 h-24 rounded-full flex items-center justify-center overflow-hidden" style={{ backgroundColor: colors.light }}>
                {teacher.profile?.photo?.url ? (
                  <img
                    src={teacher.profile.photo.url}
                    alt={teacher.name}
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex gap-2 flex-wrap">
                  ...
                  {!teacher.isActive && (
                    <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs" style={{ backgroundColor: colors.accent + '20', color: colors.accent }}>
                      <UserX size={12} /> Inactive
                    </span>
                  )}
                  {teacher.profileCompleted && (
                    <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs" style={{ backgroundColor: colors.primary + '20', color: colors.primary }}>
                      <FileText size={12} /> Profile Complete
                    </span>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Left Column - Personal Information */}
              <div>
                <h5 className="text-md font-semibold mb-3 flex items-center gap-2" style={{ color: colors.primary }}>
                  <User size={16} /> Personal Information
                </h5>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg" style={{ backgroundColor: colors.light }}>
                  ...
                  {teacher.profile && (
                    <>
                      {teacher.profile.mobileNumber && (
                        <div className="flex items-center gap-3 p-3 rounded-lg" style={{ backgroundColor: colors.light }}>
                          ...
                          <div>
                            ...
                            <p className="font-medium">{teacher.profile.mobileNumber}</p>
                          </div>
                        </div>
                      )}
                      ...
                      {teacher.profile.dob && (
                        <div className="flex items-center gap-3 p-3 rounded-lg" style={{ backgroundColor: colors.light }}>
                          ...
                          <div>
                            ...
                            <p className="font-medium">
                              {new Date(teacher.profile.dob).toLocaleDateString("en-GB")}
                            </p>
                          </div>
                        </div>
                      )}
                      ...
                      {teacher.profile.bloodGroup && (
                        <div className="flex items-center gap-3 p-3 rounded-lg" style={{ backgroundColor: colors.light }}>
                          <Droplet size={18} style={{ color: colors.primary }} />
                          <div>
                            <p className="text-xs text-gray-500">Blood Group</p>
                            <p className="font-medium">{teacher.profile.bloodGroup}</p>
                          </div>
                        </div>
                      )}
                      ...
                      {teacher.profile.highestQualification && (
                        <div className="flex items-center gap-3 p-3 rounded-lg" style={{ backgroundColor: colors.light }}>
                          ...
                          <div>
                            ...
                            <p className="font-medium">{teacher.profile.highestQualification}</p>
                          </div>
                        </div>
                      )}
                      ...
                      {teacher.profile.address && (
                        <div className="flex items-center gap-3 p-3 rounded-lg" style={{ backgroundColor: colors.light }}>
                          ...
                          <div>
                            <p className="text-xs text-gray-500">Address</p>
                            <p className="font-medium">{teacher.profile.address}</p>
                          </div>
                        </div>
                      )}
                    </>
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleDownload(
                                teacher.profile.documents.aadharCard.url,
                                getFileName(teacher.profile.documents.aadharCard.url),
                              )
                            }
                            className="p-1.5 rounded-lg transition-all duration-200 hover:scale-110"
                            style={{ color: colors.primary }}
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleDownload(
                                teacher.profile.documents.panCard.url,
                                getFileName(teacher.profile.documents.panCard.url),
                              )
                            }
                          >
                            <Download size={16} />
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">Educational Document</p>
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <button
                            onClick={() =>
                              openDocumentPreview(
                                teacher.profile.documents.qualificationCertificate.url,
                                "Qualification Certificate",
                              )
                            }
                            className="p-1.5 rounded-lg transition-all duration-200 hover:scale-110"
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleDownload(
                                teacher.profile.documents.qualificationCertificate.url,
                                getFileName(teacher.profile.documents.qualificationCertificate.url),
                              )
                            }
                          >
                            <Download size={16} />
              ...
              <div className="flex gap-3 flex-wrap">
                {!teacher.isVerified && teacher.profileCompleted && (
                  <>
                    <button
                      onClick={() => onVerify(teacher._id)}
                      className="flex-1 text-white py-2.5 rounded-lg hover:opacity-90 transition-all duration-200 flex items-center justify-center gap-2"
                ...
                {teacher.isVerified && teacher.isActive && (
                  <button
                    onClick={() => setShowDeactivateModal(true)}
                    className="w-full text-white py-2.5 rounded-lg hover:opacity-90 transition-all duration-200 flex items-center justify-center gap-2"
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="px-6 py-4 flex justify-between items-center" style={{ backgroundColor: colors.primary }}>
              <h3 className="text-xl font-semibold text-white">{previewDocument.name}</h3>
              <button
                onClick={() => setPreviewDocument(null)}
                className="text-white hover:opacity-80 transition-colors"
              >
            ...
            <div className="px-6 py-4 border-t" style={{ borderColor: colors.light }}>
              <div className="flex justify-end">
                <button
                  type="button"
                  onClick={() => handleDownload(previewDocument.url, getFileName(previewDocument.url))}
                  className="text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:opacity-90 transition-all duration-200"
      ...
      {showRejectModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <div className="p-6">
              <p className="text-gray-700 mb-4">
                Are you sure you want to reject <strong>{teacher.name}</strong>'s application?
              </p>
              <div className="mb-4">
                <label className="block text-sm font-semibold text-gray-700 mb-2">
              ...
              <div className="flex gap-3">
                <button
                  onClick={handleReject}
                  className="flex-1 text-white py-2 rounded-lg hover:opacity-90 transition-all duration-200"
                  style={{ backgroundColor: colors.accent }}
                >
                  Reject
                </button>
      ...
      {showDeactivateModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            <div className="px-6 py-4" style={{ backgroundColor: colors.secondary }}>
              <h3 className="text-xl font-semibold text-white">Deactivate Teacher Account</h3>
            </div>
            <div className="p-6">
              <p className="text-gray-700 mb-4">
                Are you sure you want to deactivate <strong>{teacher.name}</strong>'s account?
              </p>
              <div className="mb-4">
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Reason for Deactivation <span style={{ color: colors.accent }}>*</span>
                </label>
                <textarea
                  value={deactivateReason}
                  onChange={(e) => setDeactivateReason(e.target.value)}
                  ...
                  onFocus={(e) => e.target.style.boxShadow = `0 0 0 2px ${colors.secondary}20`}
                  onBlur={(e) => e.target.style.boxShadow = ''}
                  placeholder="Please provide a reason for deactivation..."
                />
              </div>
